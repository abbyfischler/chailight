...
<br></br>
          ...
          <label htmlFor="institution_name">Institution Name (required)</label>
            <input className="bg-gray-200 border-b-2 border-gray-400 focus-within:outline-none focus-within:border-gray-600" type="text" id="name" placeholder="Harvard" {...register("institution_name", { required: true })} />
            <label htmlFor="`institution_picture`">Please upload a picture of the Institution's response.</label>
            <input className="bg-gray-200 border-b-2 border-gray-400 focus-within:outline-none focus-within:border-gray-600" type="file" id="institution_picture" {...register("institution_picture", { required: true })} />
